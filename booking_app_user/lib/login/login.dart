...
import 'package:booking_app_user/login/cadastro.dart';
import 'package:booking_app_user/modelos/usuario.dart';
import 'package:booking_app_user/servicos/usuarioService.dart';
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Home(usuario: Usuario.getUsuarioNaoLogado()),
                  ),
                );
              },
